...
BOOST_AUTO_TEST_CASE(test_drop_on_empty_queue_throws) {
  petrenko::Queue<int> q;
  BOOST_CHECK_THROW(q.drop(), std::underflow_error);
}

BOOST_AUTO_TEST_CASE(test_front_on_empty_throws) {
  petrenko::Queue<int> q;
  BOOST_CHECK_THROW(q.front(), std::underflow_error);
}

BOOST_AUTO_TEST_CASE(test_back_on_empty_throws) {
  petrenko::Queue<int> q;
  BOOST_CHECK_THROW(q.back(), std::underflow_error);
}
